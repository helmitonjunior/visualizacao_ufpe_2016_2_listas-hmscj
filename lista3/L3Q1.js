...
function renderDataset(){
 ...
 /*
	...
	color.domain([
		d3.min(dataset, function(d) { return d.properties.value; }), 
		d3.max(dataset, function(d) { return d.properties.value; })
		]) 
		.range([0,255]);
...
function init(){
	...
	.on("mouseup",function(d){	
		...
		console.log("Automóveis e outros :"+aut);
		console.log("Ciclistas :"+cic);
		console.log("Ciclomotores :"+cico);
	    console.log("Motocicletas :"+mot);
		console.log("Pedestres :"+ped);
		} else {
			svg.select( ".selection").remove();
			selecting = 0;
		}
